...
import AdminSidebar, { NAV_ITEMS } from '../../components/admin/layout/AdminSidebar';
...
const AdminDashboard: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen bg-slate-50 font-sans" dir="rtl">
      ...
      {/* Main Content */}
      <div className="flex-1 flex flex-col min-w-0"> {/* min-w-0 to prevent flex item overflow */}
        <AdminTopbar
          title={NAV_ITEMS.find(item => item.id === activeTab)?.label || 'نظرة عامة'}
          onMenuClick={() => setMobileMenuOpen(true)}
          onAddStaffClick={() => setShowStaffModal(true)}
        />
